...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 p-4 bg-[#25D366] text-white rounded-2xl shadow-2xl transition-all duration-500 hover:bg-[#1ebc56] hover:scale-110 active:scale-95 group flex items-center gap-3 overflow-hidden ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-50 pointer-events-none'
        }`}
